...
printf_local "  - running three process"; echo
...
{ cat in.txt | grep f | sort | tr a-z A-Z; } 2>err1_ref.txt >out1_ref.txt
{ cat in.txt | grep f | sort --not-a-flag | tr a-z A-Z; } 2>err2_ref.txt >out2_ref.txt
